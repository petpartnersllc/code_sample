# SandBox
In the SandBox exercise, you'll be using the Elixir language to interact with the [Box](https://www.box.com) API.  
...
4) Make sure all tests are passing and add any new tests you feel are important

5) Email us back and let us know what you've come up with!
